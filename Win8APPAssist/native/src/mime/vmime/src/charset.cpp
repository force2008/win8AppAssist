...
charset::charset(const string& name)
	: m_name(name)
{
	// by yangchenwei@corp.netease.com 2012-09-07
	if (name.compare("utf8")==0
		|| name.compare("UTF8") == 0)
		m_name = charsets::UTF_8;

	if (name.compare("gb2312") == 0
		|| name.compare("GB2312") == 0)
		m_name = charsets::GB18030;
}
...
charset::charset(const char* name)
	: m_name(name)
{
	// by yangchenwei@corp.netease.com 2012-09-10
	if (m_name.compare("utf8")==0
		|| m_name.compare("UTF8") == 0)
		m_name = charsets::UTF_8;

	if (m_name.compare("gb2312") == 0
		|| m_name.compare("GB2312") == 0)
		m_name = charsets::GB18030;
}
