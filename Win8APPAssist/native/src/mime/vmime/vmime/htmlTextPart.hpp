...
public:
	...
	private:
		...
		encoding m_encoding;
		string m_id;
		word m_name; /* added by yangchenwei@corp.netease.com 2012-08-07 */
		mediaType m_type;
	};
	...
	/** Embed an object and returns a string which identifies it.
	  ...
	  * object among all other embedded objects
	  */
	const string addObject(ref <contentHandler> data, const word& name, const std::string& id, const encoding& enc, const mediaType& type);
