(function () {
    ...
    WinJS.UI.Pages.define("/test/jst/jst.html", {
        ...
        addSenior: function (event) {
            var _econtent = Util.Element.getElement('seniors');
            var _html = Util.JST.getTextTemplate('seniorTextTemplate');
            var _node = Util.Element.html2node(_html);
        ...
        addHtmlTemplate: function (event) {
            ...
            var _node = Util.Element.html2node(_html);
            var _econtent = Util.Element.getElement('htmlTemplate');
            _econtent.appendChild(_node);
        },
