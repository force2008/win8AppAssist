    ...
    WinJS.UI.Pages.define("/pages/list/list.html", {
        ...
        ready: function (element, options) {
            ...
            WinJS.UI.processAll().then(function () {
                ...
                template.render(this.playerDom, Util.getElement('container'));
                var template = element[1].winControl;
                //template.render(player, Util.getElement('container1'));
            }.bind(this));
            Util.getElement('changeData').addEventListener('click',this.changeData.bind(this));
            Util.getElement('changeData1').addEventListener('click', function () { player.name = 'aaa'; player.color.fore = '#000' }, 'false');
        },
        changeData: function () {
